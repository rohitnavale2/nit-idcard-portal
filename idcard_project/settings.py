...
# Hour (24h, local time) after which general biometric attendance is marked "late"
ATTENDANCE_LATE_HOUR    = config('ATTENDANCE_LATE_HOUR',    default=9,  cast=int)
# Grace period in minutes after class start_time before attendance is "late"
ATTENDANCE_GRACE_MINUTES = config('ATTENDANCE_GRACE_MINUTES', default=10, cast=int)
